// The interface for the mixture of C++ and Matlab. Mainly for optical flow method of PyrLK. 
...
void mexFunction(int nlhs,mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    float result = 0;
    if (!strcmp(funcname, "PyrLK"))
    {
        result = imgFeatureStrategic(PyrLK, img_1, img_2, img_dst, strategic);
    }
    mexPrintf("%f \n", result/INT_FLOAT);
